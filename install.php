 ...
 switch ($instPos) { // Lépés szám alapú váltás
	...
	case 2:
		...
		<form action='" .$_SERVER['PHP_SELF']. "' method='POST'>
			...
			<p class='formText'>Weboldal domain neve (a legvégső / jel nélkül!)<a class='feature-extra'><span class='hover'><span class='h3'><center><span class='star'>*</span> Kötelezően kitöltendő mező <span class='star'>*</span></center></span>Ezt a mezőt kötelező kitölteni, kitöltése nélkül az űrlap érvénytelenül lesz beadva.</span><span class='star'>*</span></a>: <input type='text' name='phost' value='" .$_SERVER['SERVER_ADDR']. "'><br>
