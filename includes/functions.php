...
/* Meghajtó tárterület */
 ...
 function EmoticonParse ( $emotText ) // Hangulatjelek értelmezése
 {
	...
	/* Kisbetűk */
	$emote = array(":)", ":(", ":h", ":p", ";)", ":o", ":d", ":confused:", ":neutral:", ":sleep:", ":'(", ":wonder:", ":jawohl:", ":offtopic:", ":spam:", ":wned:", ":banhammer:", "(l)", ":s"); // Emotikon kódok
	$hrefs = array("[img]/themes/" .$_SESSION['themeName']. "/emote/smile.gif[/img]", "[img]/themes/" .$_SESSION['themeName']. "/emote/sad.gif[/img]", "[img]/themes/" .$_SESSION['themeName']. "/emote/cool.gif[/img]", "[img]/themes/" .$_SESSION['themeName']. "/emote/tongue.gif[/img]", "[img]/themes/" .$_SESSION['themeName']. "/emote/wink.gif[/img]", "[img]/themes/" .$_SESSION['themeName']. "/emote/ohmy.gif[/img]", "[img]/themes/" .$_SESSION['themeName']. "/emote/grin.gif[/img]", "[img]/themes/" .$_SESSION['themeName']. "/emote/confused.gif[/img]", "[img]/themes/" .$_SESSION['themeName']. "/emote/neutral.gif[/img]", "[img]/themes/" .$_SESSION['themeName']. "/emote/closedeyes.gif[/img]", "[img]/themes/" .$_SESSION['themeName']. "/emote/cry.gif[/img]", "[img]/themes/" .$_SESSION['themeName']. "/emote/unsure.gif[/img]", "[img]/themes/" .$_SESSION['themeName']. "/emote/jawohl.gif[/img]", "[img]/themes/" .$_SESSION['themeName']. "/emote/offtopic.gif[/img]", "[img]/themes/" .$_SESSION['themeName']. "/emote/spam.gif[/img]", "[img]/themes/" .$_SESSION['themeName']. "/emote/owned.gif[/img]", "[img]/themes/" .$_SESSION['themeName']. "/emote/banhammer.gif[/img]", "[img]/themes/" .$_SESSION['themeName']. "/emote/love.gif[/img]", "[img]/themes/" .$_SESSION['themeName']. "/emote/confused_smile.gif[/img]"); // Direktlinkek
	
	$kisbetu = str_replace($emote, $hrefs, $emotText);
	
	/* Nagybetűk */
	$emoteN = array(":)", ":(", ":H", ":P", ";)", ":O", ":D", ":CONFUSED:", ":NEUTRAL:", ":SLEEP:", ":'(", ":WONDER:", ":JAWOHL:", ":OFFTOPIC:", ":SPAM:", ":WNED:", ":BANHAMMER:", "(L)", ":S");  // Emotikon kódok
