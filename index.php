...
{
	// If the admin chose the LOGOUT ALL command, this will show up for him/her
	echo '<tt><font class="emphasis">admin:</font>&nbsp;Minden felhasználó ki lett jelentkeztetve.</tt>';
}
