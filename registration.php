 ...
 switch ($regPos) // A regisztrációs lépéseknek megfelelő szöveg kírása
 {
	...
	case 1:
		...
		if ( $_POST['elfogad'] != 'yes' )
		{
			...
			<p class='formText'>Választott felhasználói név<a class='feature-extra'><span class='hover'><span class='h3'>Felhasználói név</span>Ezzel fogsz a későbbiekben belépni.<br>Csak szabványos karaktereket (angol abc betűi) és számokat tartalmazhat!</span><sup>?</sup></a><span class='star'>*</span>: <input type='text' name='username' value='" .$_POST['username']."'></p>
			<p class='formText'>Jelszó<a class='feature-extra'><span class='hover'><span class='h3'>Jelszó</span>Ezzel fogsz a későbbiekben belépni.<br>Csak szabványos karaktereket (angol abc betűi) és számokat tartalmazhat!</span><sup>?</sup></a><span class='star'>*</span>: <input type='text' name='password' value='" .$_POST['password']."'></p>
			<p class='formText'>E-mail cím<a class='feature-extra'><span class='hover'><span class='h3'>E-mail</span>Csak <b>létező</b> e-mail címet adj meg!</span><sup>?</sup></a><span class='star'>*</span>: <input type='text' name='email' value='" .$_POST['email']."'></p>
