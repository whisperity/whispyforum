 ...
 switch ($regPos) // A regisztrációs lépéseknek megfelelő szöveg kírása
 {
	...
	case 1:
		...
		if ( $_POST['elfogad'] != 'yes' )
		{
			...
			<a class='feature-extra'><span class='hover'><span class='h3'><center><span class='star'>*</span> Kötelezően kitöltendő mező <span class='star'>*</span></center></span>Ezt a mezőt kötelező kitölteni, kitöltése nélkül az űrlap érvénytelenül lesz beadva.</span><span class='star'>*</span></a>: <input type='text' name='password' value='" .$_POST['password']."'></p>
