...
When you logout, you're automatically redirected through this page by the engine passing vital variables. Those variables cannot be get.",
	...
	'{LANG_MODULE_FREEUNIVERSITY}'	=>	"Freeuniversity Organizer",
	'{LANG_MODULE_FREEUNIVERSITY_DESCRIPTION}'	=>	"The Freeuniversity Organizer module is a working lecture schedule and manager.",
	...
	'{LANG_CLASS}'	=>	"Class",
	'{LANG_CLASS_FORMAT}'	=>	'(Example: <font class="emphasis">12. A</font>, <font class="emphasis">ADULT SCHOOL</font> staff members use <font class="emphasis">Tan�r</font>)',
	...
	'{LANG_FREEUNIVERSITY_LECTURE_TITLE}'	=>	"Title",
	'{LANG_FREEUNIVERSITY_LECTURE_DESCRIPTION}'	=>	"Description",
	'{LANG_FREEUNIVERSITY_HOUR}'	=>	"Hour",
	...
	'{LANG_FREEUNIVERSITY_MANAGE_REGISTER_OBTAIN}'	=>	"Obtain a register",
	'{LANG_FREEUNIVERSITY_PRINT}'	=>	"Attendance register",
	'{LANG_SIGNATURE}'	=>	"Signature",
	'{LANG_FREEUNIVERSITY_ROSTER_USAGE}'	=>	"To obtain a roster, select the desired group from the drop-down list below and click on the button.",
	'{LANG_FREEUNIVERSITY_ROSTER_OPTION}'	=>	"{F_CLASS} ({NUMSTUD} student(s))",
	'{LANG_FREEUNIVERSITY_ROSTER_OBTAIN}'	=>	"Obtain roster",
	'{LANG_FREEUNIVERSITY_ROSTER_OBTAIN_ALL}'	=>	"Obtain roster for every user",
	'{LANG_FREEUNIVERSITY_MANAGE_DELETE_ERROR}'	=>	"Unable to delete lecture <tt>{LECTURE_TITLE}</tt>",
	'{LANG_FREEUNIVERSITY_MANAGE_DELETE_ERROR_1}'	=>	"Due to an SQL error, the lecture could not be deleted.",
	'{LANG_FREEUNIVERSITY_MANAGE_DELETE_SUCCESS}'	=>	"Removed lecture <tt>{LECTURE_TITLE}</tt>",
	'{LANG_FREEUNIVERSITY_MANAGE_DELETE_SUCCESS_1}'	=>	"The lecture has been removed from the database. Every student attending had their attendance revoked.",
	'{LANG_FREEUNIVERSITY_NEWLECTURE}'	=>	"Add new lecture",
	...
	'{LANG_FREEUNIVERSITY_SCHEDULE}'	=>	"Schedule",
	'{LANG_FREEUNIVERSITY_SCHEDULE_ATTEND}'	=>	"Attend",
	'{LANG_FREEUNIVERSITY_SCHEDULE_ATTEND_USAGE}'	=>	"This table below lists all lectures available. To sign up for attending one, click on the button. If the button is not present, you cannot attend the lecture.",
	'{LANG_FREEUNIVERSITY_SCHEDULE_INCONSISTENCY}'	=>	"This lecture's data is inconsistent due to physically impossible conflicts in the setup. To countermeasure further destruction of the database, Scheduler has blocked students from attending this lecture.",
	'{LANG_FREEUNIVERSITY_SCHEDULE_DIRECT_OPENING}'	=>	"Direct opening",
	'{LANG_FREEUNIVERSITY_SCHEDULE_DIRECT_OPENING_BODY}'	=>	"This page does not support direct opening. A mandatory variable hasn't been passed.",
	'{LANG_FREEUNIVERSITY_SCHEDULE_INVALID_HOUR}'	=>	"Invalid hour value",
	'{LANG_FREEUNIVERSITY_SCHEDULE_INVALID_HOUR_BODY}'	=>	"The system detected an invalid hour variable passed when the script was called.",
	'{LANG_FREEUNIVERSITY_SCHEDULE_CANNOT_ATTEND}'	=>	"Cannot attend this lecture",
	'{LANG_FREEUNIVERSITY_SCHEDULE_CANNOT_ATTEND_BODY}'	=>	"You cannot attend this lecture because one or more of the following: you have already chosen a lecture to attend in this hour, the lecture is not held in this hour or the limit of students attending has been reached.",
	'{LANG_FREEUNIVERSITY_SCHEDULE_UNABLE_SIGNUP}'	=>	"Unable to sign up for the lecture <tt>{LECTURE_TITLE}</tt>",
	'{LANG_FREEUNIVERSITY_SCHEDULE_UNABLE_SIGNUP_BODY}'	=>	"Due to an SQL error, Scheduler was unable to register your attendance.",
	'{LANG_FREEUNIVERSITY_SCHEDULE_SIGNEDUP}'	=>	"Successfully attending <tt>{LECTURE_TITLE}</tt>",
	'{LANG_FREEUNIVERSITY_SCHEDULE_SIGNEDUP_BODY}'	=>	"Your attendance to the lecture was registered.",
	'{LANG_FREEUNIVERSITY_SCHEDULE_RESIGN}'	=>	"Resign",
	'{LANG_FREEUNIVERSITY_SCHEDULE_RESIGN_USAGE}'	=>	"This table lists the lectures you are already listed as one attending. To resign from attending the lecture, click on the button.",
	'{LANG_FREEUNIVERSITY_SCHEDULE_RESIGN_EMPTY}'	=>	"You are not attending a lecture in this hour. Choose one from the list below.",
	'{LANG_FREEUNIVERSITY_SCHEDULE_UNABLE_RESIGN}'	=>	"Unable to resign from the lecture <tt>{LECTURE_TITLE}</tt>",
	'{LANG_FREEUNIVERSITY_SCHEDULE_UNABLE_RESIGN_BODY}'	=>	"Due to an SQL error, Scheduler was unable to revoke your attendance.",
	'{LANG_FREEUNIVERSITY_SCHEDULE_RESIGNED}'	=>	"Successfully resigned from attendance",
	'{LANG_FREEUNIVERSITY_SCHEDULE_RESIGNED_BODY}'	=>	"Your attendance to the lecture <tt>{LECTURE_TITLE}</tt> was revoked.",
	'{LANG_FREEUNIVERSITY_EDITLECTURE}'	=>	"Edit lecture",
	'{LANG_FREEUNIVERSITY_EDITLECTURE_HEADER}'	=>	"Editing lecture <tt>{O_TITLE}</tt>",
	'{LANG_FREEUNIVERSITY_EDITLECTURE_POST}'	=>	"Edit",
	'{LANG_FREEUNIVERSITY_EDITLECTURE_LIMIT_WARNING}'	=>	"The new limit cannot be lower than the number of students currently attending. To lower the limit even further, first, turn off the lecture from this hour, and then, in a new editing session, turn it back again with the new limit. (With this, you automatically resign every attendees.)",
	'{LANG_FREEUNIVERSITY_EDITLECTURE_LIMIT_ERROR}'	=>	"Alternatively, this error might be caused by setting a lecture's limit lower than the current number of students attending it. Please, first opt out the lecture from the said hour, save the edit (this will release every student attending) and then opt it in with the new limit.",
	'{LANG_FREEUNIVERSITY_EDITLECTURE_ERROR}'	=>	"There were errors executing the SQL query to edit the entry. Press the button to try again.",
	'{LANG_FREEUNIVERSITY_EDITLECTURE_VARIABLE_ERROR}'	=>	"The lecture edition cannot be done until every required variable is entered.",
